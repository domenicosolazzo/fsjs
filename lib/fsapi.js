(function(context){
    ...
    var fileSystemManager = null; //webkitRequestFileSystem
    var fileSystem = null;//File System entry point
    var fsapi = {};
    var fileSystemJS = {};
    var files = {};
    var reader = null;
    ...
    var initialization = function initialization( ){
        ...
        //fileSystemManager = context.requestFileSystem || context.webkitRequestFileSystem;
    ...
    var removeDirectory = function removeDirectory(dirName, callback, recursively){
        ...
        if (!directory) throw Error("The directory does not exist!");
        if (!directory.isDirectory ) throw Error(dirName + " is not a directory.");
